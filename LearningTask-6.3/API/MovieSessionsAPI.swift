...
class MovieSessionsAPI {
    ...
    func getSessionBy(_ movie: Movie) -> [Sessions] {
        ...
        return [
            Sessions(comingSessions: comingSessions, by: Cinema(name: "Cinemark Boulevard Tatuapé", favorite: false)),
            Sessions(comingSessions: comingSessions, by: Cinema(name: "Cinemark Eldorado", favorite: false)),
            Sessions(comingSessions: comingSessions, by: Cinema(name: "Cinemark Paulista", favorite: false)),
            Sessions(comingSessions: comingSessions, by: Cinema(name: "Cinépolis JK Iguatemi", favorite: false)),
            Sessions(comingSessions: comingSessions, by: Cinema(name: "Espaço Itaú de Cinema - Pompéia", favorite: false)),
            Sessions(comingSessions: comingSessions, by: Cinema(name: "Kinoplex Itaim", favorite: false)),
